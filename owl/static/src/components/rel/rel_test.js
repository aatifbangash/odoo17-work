...
export class RelTest extends Component {
    static template = "owl.RelTest";
    static props = {
        ...standardFieldProps,
    ...
    setup() {
//        console.log(this.env.model.user.name)
        this.state = useState({
...
registry.category("fields").add("rel_test", RelTestObject);
